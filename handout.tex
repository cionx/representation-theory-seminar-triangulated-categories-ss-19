...
Recall that the existence of (co)limits of~{\shaped{$I$}} diagrams in~$\Ccat$ is equivalent to~$\const$ admiting adjoints
\[
...
\]
(if they exist) as \defemph{homotopy colimit} and \defemph{homotopy limit}.
